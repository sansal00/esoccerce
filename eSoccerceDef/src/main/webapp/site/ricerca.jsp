...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<h5 align="center" style="color:red; font-weight:bold;" id="messaggio"><i>Uhm, credo non ci siano articoli riguardo la ricerca appena effettuata. Puoi sempre ricercare altro!</i></h5>
	<% } if(result != null && result.size() > 0) { %>
	<center><h6><i>Hai dubbi sulla tua più adatta taglia? </i><a href="<%= response.encodeURL("./site/servizi/guida.jsp")%>">Visita la nostra guida!</a></h6></center>
...
<% } else if (bean.getNome().contains("Scarpe Calcio") || bean.getNome().contains("Scarpe Running") || bean.getNome().contains("Pallone")) { %>
<tr><td> <img src=".<%= bean.getImage()%>" width="190px" height="190px"></td></tr>
<tr><td style="vertical-align:center;"><h5 style="color:orange;"><%=bean.getNome() %></h5></td></tr>
...
<tr><td> <img src=".<%= bean.getImage()%>" width="170px" height="250px"></td></tr>
<tr><td style="vertical-align:center;"><h5 style="color:orange;"><%=bean.getNome() %></h5></td></tr>
