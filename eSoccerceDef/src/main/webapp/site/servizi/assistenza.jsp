...
<head>
	...
	<title>eSoccerce - Assistenza</title>
</head>
<body>
		<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<center><table style="text-align:center; border:5px solid orange; height: 300px; width: 600px;">
			<tr><td><h4 style="color:orange; font-weight:900;"><i>L'assistenza</i></h4></td></tr>
			<tr><td><h6>L'assistenza &egrave; disponibile dal luned&igrave; al sabato secondo i seguenti orari: <br>
			Luned&igrave;: 09.00 - 18.00 <br>
			Marted&igrave;: 09.00 - 18.00 <br>
			Mercoled&igrave;: 09.00 - 18.00 <br>
			Gioved&igrave;: 09.00 - 18.00 <br>
			Venerd&igrave;: 09.00 - 18.00 <br>
			Sabato: 09.00 - 13.00 <br>
			Seguici sui social per ottenere assistenza in modo rapido! <br>(DM Instagram, Messenger o Tweet)<br></h6></td></tr>
			<tr><td><a href="https://www.instagram.com/"><img width=20px height=20px src="<%= request.getContextPath() %>/images/instagram.png"></a>
			<a href="https://www.facebook.com/"><img width=20px height=20px src="<%= request.getContextPath() %>/images/facebook.png"></a>
			<a href="https://twitter.com/"><img width=20px height=20px src="<%= request.getContextPath() %>/images/twitter.png"></a></td></tr>
			<tr><td><img src="<%= request.getContextPath() %>/images/assistenza.png"></td></tr></table></center>
		</div>
	</div>
