...
<head>
	...
	<title>eSoccerce - Spedizione</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<center><table style="text-align:center; border:5px solid orange; height:300px; width: 600px;">
			<tr><td style="vertical-align:center"><h4 style="color:orange; font-weight:900;"><i>La spedizione</i></h4></td></tr>
			<tr><td style="vertical-align:center; text-align:justify;"> <h6>La spedizione &egrave; curata dai migliori corrieri espressi che attualmente consegnano all'interno del territorio italiano, come DHL, Bartolini e GLS. Per ordini di almeno 30&euro;, la spedizione &egrave; gratuita (salvo imprevisti, la consegna &egrave; garantita entro 48h dall'affidamento dell'ordine al corriere), per ordini inferiori la spedizione ha il costo di 5&euro;.</h6></td></tr>
			<tr><td style="vertical-align:center"> <a href="https://www.dhl.com/it-it/home.html"><img width=150px height=80px src="<%= request.getContextPath() %>/images/dhl.png"></a>
			<a href="https://gls-group.com/IT/it/home"><img width=150px height=80px src="<%= request.getContextPath() %>/images/gls.png"></a>
			<a href="https://www.brt.it/it/home"><img width=150px height=50px src="<%= request.getContextPath() %>/images/bartolini.png"></a></td></tr></table></center>
