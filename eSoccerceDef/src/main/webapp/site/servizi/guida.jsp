...
<head>
	...
	<title>eSoccerce - Guida alle taglie</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<center><h3 style="color:orange; font-weight:900;"><i>Guida taglie</i></h3></center>
			<img src="<%= request.getContextPath() %>/images/tabella.png" height="450px" width="700px" class="center" style="opacity:1;">
		</div>
	</div>
