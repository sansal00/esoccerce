...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<%
	Collection<?> palloni = (Collection<?>) request.getAttribute("palloni"); 
	String error = (String) request.getAttribute("error");
	if(palloni == null && error == null){ 
...
<%
		if(palloni != null && palloni.size() > 0)
		{
			Iterator<?> it = palloni.iterator();
			while(it.hasNext())
			{
