...
<head>
	...
	<title>eSoccerce - Parastinchi</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<%
	Collection<?> parastinchi = (Collection<?>) request.getAttribute("parastinchi"); 
	String error = (String) request.getAttribute("error");
	if(parastinchi == null && error == null){ 
...
<%
		if(parastinchi != null && parastinchi.size() > 0)
		{
			Iterator<?> it = parastinchi.iterator();
			while(it.hasNext())
			{
