...
<head>
	...
	<title>eSoccerce - Email esistente!</title>
</head>
<body>
	<div class="page-container error">
		...
		<div class="panel panel-xs">
			...
			<div class="content">
				<br>L'email che hai inserito nel campo è già registrata.<br>
				Torna alla pagina per inserirne un'altra. <br>
				<a class="btn btn-primary btn-lg" href="<%= response.encodeURL("./site/registrazione.jsp")%>" role="button">Vai alla registrazione</a>
			</div>
		</div>
	</div>
