...
<head>
	...
	<title>eSoccerce - Scarpe calcio</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<%
	Collection<?> scarpecalcio = (Collection<?>) request.getAttribute("scarpecalcio"); 
	String error = (String) request.getAttribute("error");
	if(scarpecalcio == null && error == null){ 
...
<%
		if(scarpecalcio != null && scarpecalcio.size() > 0)
		{
			Iterator<?> it = scarpecalcio.iterator();
			while(it.hasNext())
			{
