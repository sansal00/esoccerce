...
<head>
	...
	<title>eSoccerce - Cambio città</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<h2 align="center" style="color:orange; font-weight: 900;"><i>Gentile <%= user.getNome()%>, qui puoi cambiare la tua citt&agrave;!</i></h2>
    ...
    <tr><td style="vertical-align:center;"><b>Citt&agrave; attuale</b></td>
      <td style="vertical-align:center;"><input type="text" name="vecchiodato" id="vecchiodato" required pattern="[a-zA-Z ()]*" title="(solo lettere, spazi e parentesi tonde)"></td>
   <tr><td style="vertical-align:center;"><b>Nuova citt&agrave;</b></td>
      <td style="vertical-align:center;"> <input type="text" name="nuovodato" id="nuovodato" required pattern="[a-zA-Z ()]*" title="(solo lettere, spazi e parentesi tonde)"></td>
  <tr><td style="vertical-align:center;"> <b>Conferma citt&agrave;</b></td>
      <td style="vertical-align:center;"> <input type="text" name="confermanuovodato" id="confermanuovodato" required pattern="[a-zA-Z ()]*" title="(solo lettere, spazi e parentesi tonde)"></td>
