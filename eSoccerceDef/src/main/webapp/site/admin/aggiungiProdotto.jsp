...
<head>
	...
	<title>eSoccerce - Aggiungi prodotto</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<% } else { %>
  	<h1 align="center" style="color:orange; font-weight:900;"><i>Aggiungi prodotto (admin)</i></h1>
  	</div>
  	<div><% 
    	String error = "ciao";
	...
	<form name="form" action="<%= response.encodeURL("../../AddProdottoControl")%>" method="POST" onSubmit = "return controlloValori(this);">    
  <center><table class="formtable" style="text-align:center; border:5px solid orange; width: 650px; height:320px;">
    <tr><td style="vertical-align:center;"><label for="code"><b>Codice</b></label></td>
      <td style="vertical-align:center;"><input type="text" name="code" id="code" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td></tr> 
    <tr><td style="vertical-align:center;"><label for="image"><b>Path immagine</b></label></td>
      <td style="vertical-align:center;"><input type="text"name="urlimage" id="urlimage" required pattern="[a-zA-Z0-9./]*" title="(solo lettere, numeri e slash)"></td></tr> 
    <tr><td style="vertical-align:center;"><label for="nomeprodotto"><b>Nome</b></label></td>
      <td style="vertical-align:center;"><input type="text" name="nomeprodotto" id="nomeprodotto" required pattern="[a-zA-Z0-9 /]*" title="(solo lettere, spazi e numeri)"></td></tr> 
    <tr><td style="vertical-align:center;"><label for="marca"><b>Marca</b></label></td>
      <td style="vertical-align:center;"><input type="text"name="marca" id="marca" required pattern="[a-zA-Z0-9 ]*" title="(solo lettere, spazi e  numeri)"></td></tr> 
    <tr><td style="vertical-align:center;"><label for="descrizione"><b>Descrizione</b></label></td>
      <td style="vertical-align:center;"><textarea name="descrizione" id="descrizione" rows="8" required pattern="[a-zA-Z0-9 ]*" title="(solo lettere e spazi)"></textarea></td></tr> 
   <tr><td style="vertical-align:center;"> <label for="prezzo"><b>Prezzo</b></label></td>
      <td style="vertical-align:center;"><input type="text"name="prezzo" id="prezzo" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td></tr> 
   <tr><td style="vertical-align:center;"> <label for="quantità"><b>Quantit&agrave;</b></label></td>
      <td style="vertical-align:center;"><input type="text" name="quantità" id="quantità" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td></tr> 
   <tr><td style="vertical-align:center;"><label for="taglia"><b>Taglia</b></label></td>
      <td style="vertical-align:center;"><input type="text"name="taglia" id="taglia" pattern="[a-zA-Z]*" title="(solo lettere)"></td></tr>
   <tr><td style="vertical-align:center;"><label for="id"><b>Numero</b></label></td>
     <td style="vertical-align:center;"><input type="text"name="numero" id="numero" value="0" pattern="[0-9]*" title="(solo numeri)" onfocus="if(this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'" ></td></tr> 
   <tr><td style="vertical-align:center;"><label for="dimensione"><b>Dimensione</b></label></td>
      <td style="vertical-align:center;"><input type="text" name="dimensione" id="dimensione" pattern="[a-zA-Z0-9]*" title="(solo lettere e numeri)"></td></tr> 
   <tr><td style="vertical-align:center;"><label for="tipo"><b>Tipo</b></label></td>
      <td style="vertical-align:center;"><input type="text"name="tipo" id="tipo" pattern="[a-zA-Z]*" title="(solo lettere)"></td></tr>                     
      <tr><td style="vertical-align:center;" colspan="2"><center><button type="submit" id="submit"><b><i>Aggiungi prodotto</i></b></button>
      <button type="reset"><b><i>Resetta campi</i></b></button></center></td></tr></table></center>
</form>
<% } %>
</div>
	</div>
