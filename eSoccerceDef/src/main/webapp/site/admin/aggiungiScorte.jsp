...
<head>
	...
	<title>eSoccerce - Aggiungi scorte</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<div class="text-left" style="length:350px; width:500px; align-content: center; width: 50%; margin: 0 auto;">
  	<h1 align="center" style="color:orange; font-weight:900;"><i>Aggiungi scorte (admin)</i></h1>
  	</div>
  	<div><% 
	...
	<form name="form" action="<%= response.encodeURL("../../AddScorteControl")%>" method="POST" onSubmit = "return controlloValori(this);">    
    <center><table class="formtable" style="text-align:center; border:5px solid orange; font-size:20px; height:150px; width:600px;">
    <tr><td style="vertical-align:center;"><label for="code"><b>Codice prodotto</b></label></td>
      <td style="vertical-align:center;"><select name="code" id="code" style="background: #fafafa; color: #636363; border-radius: 5px; border: 2px solid #757575; width: 83%;"> 
      ...
      <% } %>
       ...
       <tr><td style="vertical-align:center;"><label for="quantità"><b>Quantit&agrave; da aggiungere</b></label></td>
		<td style="vertical-align:center;"><input type="text" name="quantità" id="quantità" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td></tr>
      <tr><td style="vertical-align:center;" colspan="2"><button type="submit" id="submit"><b><i>Aggiungi scorte</i></b></button>
