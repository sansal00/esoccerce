...
<head>
	...
	<title>eSoccerce - Cambio nome</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<h2 align="center" style="color:orange; font-weight: 900;"><i>Gentile <%= user.getNome()%>, qui puoi cambiare il tuo nome!</i></h2>
   ...
   <center><table class="formtable" style="text-align:center; border:5px solid orange; font-size:20px; height:200px; width:600px;">
    <tr><td style="vertical-align:center;"><b>Nome attuale</b></td>
   ...
   <tr><td style="vertical-align:center;"><b>Nuovo nome</b></td>
  ...
  <tr><td style="vertical-align:center;"> <b>Conferma nome</b></td>
