...
<head>
	...
	<title>eSoccerce - Cambio email</title>
</head>
<body>
<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<h2 align="center" style="color:orange; font-weight:900;"><i>Gentile <%= user.getNome()%>, qui puoi cambiare la tua email!</i></h2>
 ...
 <center><table class="formtable" style="text-align:center; border:5px solid orange; font-size:20px; height:200px; width:600px;">
    <tr><td style="vertical-align:center;"><b>Email attuale</b></td>
      <td style="vertical-align:center;"><input type="text" name="vecchiodato" id="vecchiodato" required></td>
   <tr><td style="vertical-align:center;"><b>Nuova email</b></td>
      <td style="vertical-align:center;"> <input type="text" name="nuovodato" id="nuovodato" required></td>
  <tr><td style="vertical-align:center;"> <b>Conferma email</b></td>
      <td style="vertical-align:center;"> <input type="text" name="confermanuovodato" id="confermanuovodato" required></td>
...
function controlloValori(x) {
	var email = x.elements["vecchiodato"];
	var nuovaemail = x.elements["nuovodato"];
	var confermanuovaemail = x.elements["confermanuovodato"];
	...
	if (!(nuovaemail.value.match(mailformat))) {
		nuovaemail.style.border = "3px solid red";
		document.getElementById("messaggio").innerHTML = "Il formato della nuova email è errato! Riprova.";
		return false;
	}
	if (!(confermanuovaemail.value.match(mailformat))) {
		confermanuovaemail.style.border = "3px solid red";
		document.getElementById("messaggio").innerHTML = "Il formato della conferma della nuova email è errato! Riprova.";
		return false;
	}
	if (nuovaemail.value != confermanuovaemail.value) {
		nuovaemail.style.border = "3px solid red";
		confermanuovaemail.style.border = "3px solid red";
		document.getElementById("messaggio").innerHTML = "I campi della nuova email e della conferma non coincidono! Riprova.";
		return false;
		}
