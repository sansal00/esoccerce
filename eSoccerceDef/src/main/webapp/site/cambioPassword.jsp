...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<h2 align="center" style="color:orange; font-weight: 900;"><i>Gentile <%= user.getNome()%>, qui puoi cambiare la tua password!</i></h2>
    ...
    <tr><td style="vertical-align:center;"><b>Password attuale</b></td>
      <td style="vertical-align:center;"><input type="password" name="vecchiodato" id="vecchiodato" required> <img src="<%= request.getContextPath()%>/images/eye.png" width="20px" height="20px" onClick="toggle()" style="margin-top:13px;"></td>
   <tr><td style="vertical-align:center;"><b>Nuova password</b></td>
      <td style="vertical-align:center;"> <input type="password" name="nuovodato" id="nuovodato" required> <img src="<%= request.getContextPath()%>/images/eye.png" width="20px" height="20px" onClick="toggle2()" style="margin-top:13px;"></td>
  <tr><td style="vertical-align:center;"> <b>Conferma password</b></td>
      <td style="vertical-align:center;"> <input type="password" name="confermanuovodato" id="confermanuovodato" required> <img src="<%= request.getContextPath()%>/images/eye.png" width="20px" height="20px" onClick="toggle3()" style="margin-top:13px;"></td>
...
<script>
	function controlloValori(x) {
		...
		var num = nuovodato.value.length;
		if (num < 5) {
			nuovodato.style.border = "3px solid red";
			document.getElementById("messaggio").innerHTML = "La nuova password deve essere lunga almeno 5 caratteri!"
			return false;
		}
    ...
    function toggle() {
        var temp = document.getElementById("vecchiodato");
    ...
    function toggle2() {
        var temp = document.getElementById("nuovodato");
        if (temp.type === "password") {
            temp.type = "text";
        }
        else {
    ...
    function toggle3() {
        var temp = document.getElementById("confermanuovodato");
        if (temp.type === "password") {
            temp.type = "text";
        }
        else {
