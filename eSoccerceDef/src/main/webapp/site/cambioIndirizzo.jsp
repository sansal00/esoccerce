...
<head>
	...
	<title>eSoccerce - Cambio indirizzo</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<h2 align="center" style="color:orange; font-weight:900;"><i>Gentile <%= user.getNome()%>, qui puoi cambiare il tuo indirizzo!</i></h2>
    ...
    <tr><td style="vertical-align:center;"><b>Indirizzo attuale</b></td>
      <td style="vertical-align:center;"><input type="text" name="vecchiodato" id="vecchiodato" required pattern="[a-zA-Z0-9, ]*" title="(solo lettere, spazi, virgole e numeri)"></td>
   <tr><td style="vertical-align:center;"><b>Nuovo indirizzo</b></td>
      <td style="vertical-align:center;"> <input type="text" name="nuovodato" id="nuovodato" required pattern="[a-zA-Z0-9, ]*" title="(solo lettere, spazi, virgole e numeri)"></td>
  <tr><td style="vertical-align:center;"> <b>Conferma indirizzo</b></td>
      <td style="vertical-align:center;"> <input type="text" name="confermanuovodato" id="confermanuovodato" required pattern="[a-zA-Z0-9, ]*" title="(solo lettere, spazi, virgole e numeri)"></td>
