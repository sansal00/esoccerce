...
<head>
	...
	<title>eSoccerce - Pantaloncini</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
	...
	<%
	Collection<?> pantaloncini = (Collection<?>) request.getAttribute("pantaloncini"); 
	String error = (String) request.getAttribute("error");
	if(pantaloncini == null && error == null){ 
...
<%
		if(pantaloncini != null && pantaloncini.size() > 0)
		{
			Iterator<?> it = pantaloncini.iterator();
			while(it.hasNext())
			{
