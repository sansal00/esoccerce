...
<head>
	...
	<title>eSoccerce - Calzettoni</title>
</head>
<body>
	<nav class="page-nav">
		<div class="title">
...
<input type="text" placeholder="Ricerca il tuo prodotto..." name="search"></form>
		...
		<center><h6><i>Hai dubbi sulla tua più adatta taglia? </i><a href="<%= response.encodeURL("./site/servizi/guida")%>">Visita la nostra guida!</a></h6></center>
	<%
	Collection<?> calzettoni = (Collection<?>) request.getAttribute("calzettoni"); 
	String error = (String) request.getAttribute("error");
	if(calzettoni == null && error == null){ 
...
<%
		if(calzettoni != null && calzettoni.size() > 0)
		{
			Iterator<?> it = calzettoni.iterator();
			while(it.hasNext())
			{
